package com.personal.notebook.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("PersonalNotebookApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("PersonalNotebookApp");
        ...
        config.getMapConfigs().put("com.personal.notebook.domain.*", initializeDomainMapConfig(jHipsterProperties));
