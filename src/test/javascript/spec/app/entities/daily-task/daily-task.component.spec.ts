...
import { DailyTaskComponent } from 'app/entities/daily-task/daily-task.component';
...
describe('Component Tests', () => {
    describe('DailyTask Management Component', () => {
        let comp: DailyTaskComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DailyTaskComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.dailyTasks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
