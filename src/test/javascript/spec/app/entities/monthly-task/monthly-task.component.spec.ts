...
import { MonthlyTaskComponent } from 'app/entities/monthly-task/monthly-task.component';
...
describe('Component Tests', () => {
    describe('MonthlyTask Management Component', () => {
        let comp: MonthlyTaskComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MonthlyTaskComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.monthlyTasks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
